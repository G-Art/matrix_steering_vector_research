...
Ефективність "Режиму дистиляції" можна пояснити крізь призму методу **LASER (Layer-Selective Rank Reduction)**, описаного *[Sharma та ін. (2023)](https://arxiv.org/abs/2312.13558)*.
